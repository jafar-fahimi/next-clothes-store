...
const CheckoutSuccessPage: NextPage = () => {
  ...
  const URL = sessionId ? `/api/checkout_sessions/${sessionId}` : "";

  useEffect(() => {
    async function fetcher(urlData: string) {
      const jsonData = await fetch(urlData);
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
